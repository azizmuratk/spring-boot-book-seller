...
public class PurchaseHistoryController {
    ...
    @PostMapping
    public ResponseEntity<?> savePurschaseHistory(@RequestBody PurchaseHistory purchaseHistory){
    ...
    public ResponseEntity<?> getAllPurschase(@AuthenticationPrincipal UserPrincipal userPrincipal){
